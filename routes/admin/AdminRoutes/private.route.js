...
import { addbusinessInfo, getBusinessBasedOnId, getBusinessInfo } from "../AdminControllers/businessInfo.controller.js";
import { addworkerInfo, getWorkerData } from "../AdminControllers/workerInfo.controller.js";
import { addServiceInfo } from "../AdminControllers/serviceInfo.controller.js";
import { addtimeInfo, getTimeInfo } from "../AdminControllers/timeInfo.controller.js";
import { getServiceData } from "../AdminServices/serviceInfo.service.js";
...
PrivateAdminRouter.get("/getServiceData/:bid",getServiceData);
